...
import com.wang.wangpicture.manager.auth.model.SpaceUserAuthConfig;
import com.wang.wangpicture.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    // 获取权限列表(让前端在空间详情页，图片详情页，空间图片列表页可以根据权限显示不同的按钮)
